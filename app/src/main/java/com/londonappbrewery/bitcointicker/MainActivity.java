...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Log.d("BitCoin","The Position is " +i );
                Log.d("BitCoin","The value in the current currency is " + adapterView.getItemAtPosition(i));
    ...
    private void letsDoSomeNetworking(String url) {
        ...
        client.get("https://apiv2.bitcoinaverage.com/indices/global/ticker/BTCUSD", new JsonHttpResponseHandler() {
